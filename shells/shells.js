...
u_global_Shells_last_segment_info = function () {
...
function global_Shells_last_segment_info (info) {
...
u_global_Shells_growth_factors = function () {
    var args = new Pacioli.Type('tuple', Array.prototype.slice.call(arguments));
...
function global_Shells_growth_factors (growth_constant,n) {
...
// for_index D,E: for_unit a,b,c,f,g,h: (a*D!b per E!c, f*D!b/D!g per E!c/E!h) -> a*percent*D!g per f*E!h

u_global_Standard_fraction = function () {
    var args = new Pacioli.Type('tuple', Array.prototype.slice.call(arguments));
    var type = new Pacioli.Type('function', [new Pacioli.Type("tuple", [Pacioli.createMatrixType(new Pacioli.PowerProduct('_a_').expt(1), '_D_', new Pacioli.PowerProduct('_b_').expt(1), '_E_', new Pacioli.PowerProduct('_c_').expt(1)), Pacioli.createMatrixType(new Pacioli.PowerProduct('_f_').expt(1), '_D_', new Pacioli.PowerProduct('_b_').expt(1).mult(new Pacioli.PowerProduct('_g_').expt(-1)), '_E_', new Pacioli.PowerProduct('_h_').expt(-1).mult(new Pacioli.PowerProduct('_c_').expt(1)))]), Pacioli.createMatrixType(new Pacioli.PowerProduct('_a_').expt(1).mult(Pacioli.unit('percent').expt(1).mult(new Pacioli.PowerProduct('_f_').expt(-1))), '_D_', new Pacioli.PowerProduct('_g_').expt(1), '_E_', new Pacioli.PowerProduct('_h_').expt(1))]);
    return Pacioli.subs(type.ran(), Pacioli.match(type.dom(), args));
}
...
// for_unit a,b,c: (a*Space!, b*Space!, c*Space!/a/b) -> c
