...
Pacioli.compute_u_$standard_column_default_column = function () {
    return new Pacioli.FunctionType(new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_b_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])]));
}
...
Pacioli.compute_u_tables_relative_day_columns = function () {
    return new Pacioli.FunctionType(new Pacioli.GenericType("Tuple", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitType('day').expt(-1).mult(Pacioli.unitType('hour').expt(1).mult(Pacioli.unitFromVarName('_a_').expt(1))), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_b_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])]), new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_c_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])]), new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitType('day').expt(-1).mult(Pacioli.unitType('sidereal_day').expt(1).mult(Pacioli.unitFromVarName('_a_').expt(1))), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_d_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])])]));
}
...
Pacioli.compute_u_tables_total_hours = function () {
    return new Pacioli.FunctionType(new Pacioli.GenericType("Tuple", [Pacioli.createMatrixType(Pacioli.unitType('day').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), Pacioli.createMatrixType(Pacioli.unitType('hour').expt(1), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE));
}
...
Pacioli.compute_u_$standard_column_make_column = function () {
    return new Pacioli.FunctionType(new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_b_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])]), new Pacioli.GenericType("Tuple", [new Pacioli.GenericType("String", []), Pacioli.createMatrixType(Pacioli.unitFromVarName('_a_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitType('decimals').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)]), new Pacioli.GenericType("Boole", []), new Pacioli.GenericType("Maybe", [Pacioli.createMatrixType(Pacioli.unitFromVarName('_b_').expt(1), new Pacioli.IndexType([]), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE)])]));
}

Pacioli.$standard_column_make_column = function (lcl_header, lcl_value, lcl_decimals, lcl_show_total, lcl_total) {
...
Pacioli.compute_u_tables_planetary_mass = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('yotta', 'gram').expt(1), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
...
Pacioli.compute_u_tables_planetary_density = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('gram').expt(1).mult(Pacioli.unitType('centi', 'metre').expt(-3)), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
...
Pacioli.compute_u_tables_day_length = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('day').expt(-1).mult(Pacioli.unitType('hour').expt(1)), new Pacioli.IndexType(['index_tables_Planet']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
