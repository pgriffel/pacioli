...
Pacioli.compute_u_charts_population = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('person').expt(1), new Pacioli.IndexType(['index_charts_Continent']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
