...
public class UsesVars implements TypeVisitor {
    ...
    public Set<Var> typeNodeAccept(PacioliType child) {
    ...
    public void visit(FunctionType type) {
        ...
        all.addAll(typeNodeAccept(type.domain));
        all.addAll(typeNodeAccept(type.range));
        returnTypeNode(all);
    }
    ...
    public void visit(MatrixType type) {
        ...
        all.addAll(typeNodeAccept(type.rowDimension));
        all.addAll(typeNodeAccept(type.columnDimension));
        returnTypeNode(all);
    }
