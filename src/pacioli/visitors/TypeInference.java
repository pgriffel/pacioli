...
public class TypeInference extends IdentityVisitor implements Visitor {
	...
	public void visit(ApplicationNode node) {
        ...
        // Add the unification contraint that function type must equal the derived function type.
        String message = String.format("During inference %s\nthe infered type must match known types", node.sourceDescription());        
	...
	public void visit(AssignmentNode node) {
        ...
        typing.addConstraint(node.var.info.inferredType, valueTyping.getType(), "assigned variable must have proper type");
        returnNode(typing);
	}
	...
	public void visit(BranchNode node) {
        ...
        // Add the constraint that the positive and the negative branch must have the same type
        typing.addConstraint(posTyping.getType(), negTyping.getType(), String.format("While infering the type of\n%s\nthe branches of an if must have the same type", node.sourceDescription()));
	...
	public void visit(ConversionNode node) {
		// Should the true arg be based on the local property?. Remove the argument!!!! Is/should be solved during resolve.
	...
	public void visit(LambdaNode node) {
        ...
        // Create a typing for the lambda and add the constraints from the body's inference
