...
// returnTypeNode(new SchemaNode(new Location(), type.contextNodes,
// typeNodeAccept(type.getType())));
// }
...
// TypeNode right = type.devalDimensionUnitPair(type.columnDimension,
// type.columnUnit);
...
// } else {
// returnTypeNode(new TypeIdentifierNode(new Location(), type.getInfo().name(),
// type.getInfo()));
// }
// }
