...
Wolfram: the normal of the plane f = ax + by + cz + d = 0 is (a b c)^T
Stel d=1
Snijpunten met x, y, z as: (-1/a, 0, 0), (0, -1/b, 0), (0, 0, -1/c).
Vectoren zijn z-x en z-y, dus (1/a, 0, -1/c) en (0, 1/b, -1/c).
This plane has vectors (-1/a 0 1/c)^T and (0 -1/b 1/c)^T. The cross product of these is (1/bc 1/ac 1/ab)^T
(1/bc 1/ac 1/ab)^T . (abc abc abc)^T = (a b c)^T 
