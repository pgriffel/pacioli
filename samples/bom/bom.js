...
Pacioli.compute_u_$standard_matrix_kleene = function () {
    return new Pacioli.FunctionType(new Pacioli.GenericType("Tuple", [Pacioli.createMatrixType(Pacioli.ONE, '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1))]), Pacioli.createMatrixType(Pacioli.ONE, '_P_', Pacioli.unitFromVarName('_P!u_').expt(1), '_P_', Pacioli.unitFromVarName('_P!u_').expt(1)));
}
...
Pacioli.compute_u_$standard_misc_to_percentage = function () {
...
Pacioli.$standard_misc_to_percentage = function (lcl_x) {
return Pacioli.$base_matrix_scale(
Pacioli.fetchValue('$standard_misc', 'percent_conv'), 
lcl_x);
}
...
Pacioli.compute_sbase_crate = function () {
    return {definition: Pacioli.DimNum.fromNumber(0.025, Pacioli.unit('metre').expt(3)), symbol: "crt"}
}
...
Pacioli.compute_vbase_bom_Product_unit = function () { return {units: { 'ApplePie': Pacioli.unit('pie').expt(1), 'PieceOfPie': Pacioli.unit('piece').expt(1), 'Butter': Pacioli.unit('gram').expt(1), 'Flour': Pacioli.unit('gram').expt(1), 'Pastry': Pacioli.unit('kilo:gram').expt(1), 'Apples': Pacioli.unit('gram').expt(1), 'CrateOfApples': Pacioli.unit('crate').expt(1), 'Sugar': Pacioli.unit('gram').expt(1) }}};
...
Pacioli.compute_vbase_bom_Product_trade_unit = function () { return {units: { 'ApplePie': Pacioli.unit('pie').expt(1), 'PieceOfPie': Pacioli.unit('piece').expt(1), 'Butter': Pacioli.unit('kilo:gram').expt(1), 'Flour': Pacioli.unit('kilo:gram').expt(1), 'Pastry': Pacioli.unit('kilo:gram').expt(1), 'Apples': Pacioli.unit('kilo:gram').expt(1), 'CrateOfApples': Pacioli.unit('crate').expt(1), 'Sugar': Pacioli.unit('kilo:gram').expt(1) }}};
...
Pacioli.compute_u_bom_BoM = function () {
    return Pacioli.createMatrixType(Pacioli.ONE, new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_unit', 0).expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_unit', 0).expt(1));
}
...
Pacioli.compute_u_bom_conv = function () {
    return Pacioli.createMatrixType(Pacioli.ONE, new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_unit', 0).expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(1));
}
...
Pacioli.compute_u_bom_trade_BoM = function () {
    return Pacioli.createMatrixType(Pacioli.ONE, new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(1));
}
...
Pacioli.compute_u_$standard_misc_percent_conv = function () {
...
Pacioli.compute_$standard_misc_percent_conv = function () {
...
Pacioli.compute_u_bom_ingredient_breakdown = function () {
    return Pacioli.createMatrixType(Pacioli.ONE, new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(1), new Pacioli.IndexType([]), Pacioli.ONE);
}
...
Pacioli.oneNumbersFromShape(Pacioli.createMatrixType(Pacioli.ONE, new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(1), new Pacioli.IndexType([]), Pacioli.ONE))));
}

Pacioli.compute_u_bom_price = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('dollar').expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.unitVectorType('vbase_bom_Product_trade_unit', 0).expt(-1), new Pacioli.IndexType([]), Pacioli.ONE);
}
...
Pacioli.compute_u_bom_cost_breakdown = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('dollar').expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
...
Pacioli.compute_u_bom_cost_breakdown_in_percentages = function () {
    return Pacioli.createMatrixType(Pacioli.unitType('percent').expt(1), new Pacioli.IndexType(['index_bom_Product']), Pacioli.ONE, new Pacioli.IndexType([]), Pacioli.ONE);
}
Pacioli.compute_bom_cost_breakdown_in_percentages = function () {
  return Pacioli.$standard_misc_to_percentage(
