...
return function (sym_535, lcl_count, lcl__, lcl_trace, lcl_final_net, lcl__, lcl_player_one_wins, lcl_valid) {
return Pacioli.$base_base__catch_void(
function () {
return Pacioli.$base_base__seq(
Pacioli.$base_io_print(
...
return function (sym_335, lcl_i, lcl_i, lcl_n, lcl_p, lcl_j, lcl_pi, lcl_nu, lcl_j) {
...
return function (sym_454, lcl_m, lcl_available, lcl_todo, lcl_i, lcl_i, lcl_todo, lcl_available, lcl_net, lcl_firing, lcl_total, lcl_todo, lcl_total) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
...
Pacioli.$base_base__ref_get(lcl_total)))))))))); } ,
sym_454); }( 
Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__new_ref(lcl_net), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref());
}
...
return function (sym_18, lcl_i, lcl_i, lcl_result, lcl_size, lcl_result) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
...
return function (sym_453, lcl_enabled, lcl_score, lcl_best_score, lcl_best_score, lcl_best_trace, lcl_marking, lcl_best_trace, lcl_trace) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
...
return function (sym_452, lcl_not_fired, lcl_count, lcl_fired, lcl_net, lcl_valid, lcl_not_fired, lcl_count, lcl_valid, lcl_fired) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
...
Pacioli.$base_base__ref_get(lcl_not_fired))))))))); } ,
sym_452); }( 
Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__new_ref(lcl_net), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref(), Pacioli.$base_base__empty_ref());
}
...
return function (sym_339, lcl_k, lcl_neg, lcl_r, lcl_n, lcl_k, lcl_q, lcl_minimal, lcl_l, lcl_neg, lcl_i, lcl_q, lcl_pos, lcl_minimal, lcl_pos, lcl_neg_size, lcl_j, lcl_l, lcl_minimal, lcl_tmp, lcl_pos_size, lcl_i, lcl_m, lcl_i, lcl_alpha, lcl_beta) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
Pacioli.$base_base__ref_set(lcl_n, Pacioli.$base_list_list_size(
...
return function (sym_336, lcl_x, lcl_sub_found, lcl_i, lcl_i, lcl_n, lcl_sub_found) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
...
return function (sym_337, lcl_pi_0, lcl_i, lcl_optimal, lcl_best_prod, lcl_rows, lcl_size, lcl_optimal, lcl_chosen, lcl_rows, lcl_choice, lcl_quads, lcl_prod, lcl_pi, lcl_quads, lcl_quads, lcl_i, lcl_chosen, lcl_nu_p, lcl_i, lcl_choice, lcl_chosen, lcl_nu, lcl_best_prod, lcl_rows, lcl_choice, lcl_i, lcl_p, lcl_nu_0, lcl_pi_p) {
return Pacioli.$base_base__catch_result(
function () {
return Pacioli.$base_base__seq(
